...
const Kidsdrop = () => {
  ...
  return (
    ...
    <div className="w-screen bg-white shadow-xl flex">
      ...
      <div className="w-1/4 bg-gray-100">
        <ul className="flex flex-col gap-5 p-[60px] text-sm">
          ...
          <li className="hover:underline cursor-pointer">Shirt</li>
          ...
          <li className="hover:underline cursor-pointer">Trouser</li>
        </ul>
      </div>
      ...
      <div className="w-3/4 flex flex-col gap-6 p-10">
        ...
        <h1 className="text-lg border-b pb-2">KIDs's Section</h1>
    ...
    <p className={p}>Explore now</p>          </div>
          ...
          <h3 className={h3}> Shoe Collection </h3>
    <p className={p}>Explore now</p>          </div>

     <div className='relative'>
          <img src={img3} className="w-48 h-60 object-cover" />
          <h3 className={h3}> Trouser </h3>
    <p className={p}>Explore now</p>          </div>
