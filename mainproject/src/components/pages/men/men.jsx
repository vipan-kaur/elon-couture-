...
// 
 return (
  ...
  {/* <span className="absolute left-0 top-7 w-full h-[2px] bg-white transition-all duration-200 hover:top-5"></span> */}
       ...
       <div className="hidden duration-700 ease-in-out absolute"  data-carousel-item>
          <img 
            ...
            alt="..."
          />
                <div className="absolute w-full md:w-1/3 inset-y-0 left-0 md:left-10 z-10 flex flex-col gap-3 justify-center text-left text-white p-4 md:p-10">
  {/* Brand name */}
  <Typography variant="subtitle2" className="uppercase tracking-widest text-sm md:text-base">
    Elan Couture
  </Typography>
  ...
  {/* Features / Highlights */}
  <ul className="list-none space-y-1 text-white text-xs md:text-base">
    <li>✔ Long-lasting captivating fragrances</li>
    <li>✔ Crafted from premium natural ingredients</li>
    <li>✔ Luxurious bottles with elegant design</li>
    <li>✔ Perfect for every occasion</li>
    <li>✔ Signature scents that leave a lasting impression</li>
  </ul>

  {/* Call to action */}
  <Typography
    variant="body1"
    className="cursor-pointer underline underline-offset-4 hover:underline-offset-2 transition-all duration-300 text-sm md:text-base"
  >
    Shop Now
  </Typography>
</div>
...
Discover premium menswear designed for the modern man. From timeless essentials to bold statement pieces — upgrade your wardrobe with unmatched quality and comfort
        ...
        <Link to="/menproducts"><button className="px-6 py-3 bg-black text-white rounded-md hover:bg-gray-800 transition">
          shop now
        </button></Link>
